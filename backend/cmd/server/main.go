...
func main() {
	...
	batches := service.NewBatchService(batchRepo, sensors, greenhouses, l, hub)
	engine := router.New(router.Dependencies{Config: cfg, Logger: l, Auth: auth, Monitoring: monitoring, Alerts: alertService, Control: control, Reports: reports, Batches: batches, Hub: hub})
